...
export const StarIcon: React.FC<IconProps & { filled?: boolean }> = ({ size = 18, className = '', filled = true, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={filled ? "#F1C40F" : "none"} stroke="#F1C40F" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
